...
export default function BinaryConverter() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
      <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-1">Binary converter</h2>
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Enter a decimal number to convert</p>
      <input
        type="number"
        value={input}
        onChange={e => convert(e.target.value)}
        placeholder="e.g. 255"
        className="w-full border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-lg px-3 py-2 text-sm mb-4 focus:outline-none focus:border-blue-400"
      />
      {valid && (
