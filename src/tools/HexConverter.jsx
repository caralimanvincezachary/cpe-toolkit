...
export default function HexConverter() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
      <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-1">Decimal ↔ Hex converter</h2>
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Type in either field to convert</p>
      <label className="text-sm text-gray-500 dark:text-gray-400">Decimal</label>
      <input type="number" value={dec} onChange={e => fromDec(e.target.value)}
        placeholder="e.g. 255"
        className="w-full border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-lg px-3 py-2 text-sm my-2 focus:outline-none focus:border-blue-400" />
      <div className="text-center text-gray-400 text-lg my-1">⇅</div>
      <label className="text-sm text-gray-500 dark:text-gray-400">Hexadecimal</label>
